...
class Metaclass_Conversion_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('image_processing')
        except ImportError:
            import logging
            import traceback
...
class Conversion_Request(metaclass=Metaclass_Conversion_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.conversion_mode = kwargs.get('conversion_mode', bool())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.conversion_mode != other.conversion_mode:
            return False
        return True
    ...
    def conversion_mode(self, value):
        if __debug__:
            assert \
                ...
                "The 'conversion_mode' field must be of type 'bool'"
...
class Metaclass_Conversion(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from image_processing.srv import _conversion
...
class Conversion(metaclass=Metaclass_Conversion):
    from image_processing.srv._conversion import Conversion_Request as Request
    from image_processing.srv._conversion import Conversion_Response as Response
